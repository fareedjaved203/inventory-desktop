  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-gray-800 mb-0">Reports</h1>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="text-left">
              <h2 className="text-xl font-bold text-gray-800">Summary Reports</h2>
              <p className="text-gray-600 text-sm">Profit/Loss, Sales, Purchase & Expense statements</p>
            </div>
          </div>
        </button>
      </div>
