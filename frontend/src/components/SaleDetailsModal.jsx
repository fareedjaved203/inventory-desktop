          ...
          <div className="flex gap-2">
            ...
            <div className="flex items-center gap-1">
              <select
                ...
                className="px-2 py-2 border border-gray-300 rounded-l-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-green-500"
              >
              ...
              <button
                onClick={() => {
                  if (printType === 'thermal') {
                    ...
                    import('@react-pdf/renderer').then(({ pdf }) => {
                      pdf(<SaleInvoicePDF sale={currentSale} shopSettings={shopSettings} preferences={pdfPreferences} pageSize={printType === 'a5' ? 'A5' : 'A4'} />)
                        .toBlob()
                        .then(blob => {
                ...
                className="bg-gradient-to-r from-green-600 to-green-700 text-white px-4 py-2 rounded-r-lg hover:from-green-700 hover:to-green-800 shadow-sm flex items-center gap-2 text-sm"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
