...
export const productSchema = z.object({
  ...
  quantity: z.number().min(0, "Quantity must be non-negative").max(1000000000, "Quantity cannot exceed 1 billion").optional().default(0),
...
export const contactSchema = z.object({
  ...
  contactType: z.enum(["customer", "supplier", "both", "order_booker"]).optional().default("customer"),
});
...
export const querySchema = z.object({
  ...
  isService: z.union([z.string(), z.boolean()]).optional(),
